        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.hzVersion = iprot.readString().decode('utf-8') if sys.version_info[
                                                                               0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.xmlconfig = iprot.readString().decode('utf-8') if sys.version_info[
                                                                               0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
...
class startMember_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.clusterId = iprot.readString().decode('utf-8') if sys.version_info[
                                                                               0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.memberId = iprot.readString().decode('utf-8') if sys.version_info[
                                                                              0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
